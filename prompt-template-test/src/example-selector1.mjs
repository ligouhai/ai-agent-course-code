/*
 * @Date: 2026-05-19 18:17:09
 * @LastEditors: zhujinyi
 * @LastEditTime: 2026-05-19 18:25:33
 */
...
// 4.创建 LengthBasedExampleSelector 实例
const exampleSelector = await LengthBasedExampleSelector.fromExamples(
  examples,
  {
    examplePrompt,
    // 这里简单的用字符长度近似控制，真实项目中可以配合 token 估算
    maxLength: 700,
    getTextLength: (text) => text.length
  }
);

// 5. 创建 FewShotPromptTemplate 实例
