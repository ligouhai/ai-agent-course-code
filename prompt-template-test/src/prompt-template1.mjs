/*
 * @Date: 2026-05-19 10:04:10
 * @LastEditors: zhujinyi
 * @LastEditTime: 2026-05-19 10:21:18
 */
...
const naiveTemplate = PromptTemplate.fromTemplate(`
    你是一名严谨但不是人情味的工程团队负责人，需要根据本周数据写一份周报
    ...
    - 预期专业但有一点人情味，适合作为给老板和团队抄送的周报
    `);

const prompt = await naiveTemplate.format({
  company_name: '字节跳动',
  department_name: '数据智能平台组',
  manager_name: '刘总',
  week_range: '2026-05-19 ~ 2026-05-25',
  team_goal: '完成用户画像的灰度上线，并验证核心指标是否达标',
  dev_activities: `
