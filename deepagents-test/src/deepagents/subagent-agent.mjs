/*
 * @Date: 2026-07-09 09:40:47
 * @LastEditors: zhujinyi
 * @LastEditTime: 2026-07-09 10:18:58
 */
...
const subagents = [
  ...
  },
  {
    name: "kid-tutor",
    description:
      "把 math-solver 的解题过程讲给家长听，方便辅助孩子。description 里会有完整解题过程",
    systemPrompt: [
      "你是辅导讲解子 Agent，面向小学生家长。",
      "根据 description 中的解题过程，用短句、比喻或分布提问方式讲解（不要堆公式）。",
...
const agent = createAgent({
  ...
  systemPrompt: [
    ...
    "按顺序：1.math-solver 2.kid-tutor（把 solver 完整过程写进 description） 3.practice-maker。",
    "最后想家长汇总：答案、辅导要点、两道练习题。中文",
  ].join("\n"),
  middleware: [
