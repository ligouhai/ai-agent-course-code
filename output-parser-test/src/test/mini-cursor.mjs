/*
 * @Date: 2026-05-18 18:04:42
 * @LastEditors: zhujinyi
 * @LastEditTime: 2026-05-18 19:00:48
 */
...
async function runAgentWithTools(query, maxIterations = 30) {
  ...
  await history.addMessage(
    new SystemMessage(`你是一个助手，使用工具完成任务。
      当前工作目录：${process.cwd()}
      ...
      - 当使用 workingDirectory 参数时，绝对不要在 command 中使用 cd
  ...
  for (let i = 0; i < maxIterations; i++) {
    ...
    console.log(chalk.bgBlue('Agent 开始思考并生成流...'));
