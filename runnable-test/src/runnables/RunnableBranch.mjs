/*
 * @Date: 2026-05-21 15:10:40
 * @LastEditors: zhujinyi
 * @LastEditTime: 2026-05-21 15:15:15
 */
...
for (const input of testCases) {
  const result = await branch.invoke(input);
  console.log(`输入: ${input}, 结果: ${result}`);
}
