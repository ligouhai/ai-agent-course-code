/*
 * @Date: 2026-05-09 14:59:09
 * @LastEditors: zhujinyi
 * @LastEditTime: 2026-05-09 15:13:34
 */
...
async function summarizeHistoryDemo() {
  ...
  const maxTokens = 200; // 最大token数
  const keepRecentTokens = 80; // 保留最近80个token
...
summarizeHistoryDemo().catch(console.error);
